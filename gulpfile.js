...
// big PATH
var TemplatePath = 'build';
var TemplateAppPath = 'app';
var projectTarget = "http://localhost/awesomegallery/build/index.html";
var path = {
    build: { //prod
        html: TemplatePath + '/',
        js: TemplatePath + '/js/',
    ...
    src: { //develop
        html: [TemplateAppPath + '/**/*.html', TemplateAppPath + '/**/*.php'],
        img: TemplateAppPath + '/images/**/*.*',
        sprite: TemplateAppPath + '/images/icons/*.svg',
        css: TemplateAppPath + '/css/*.css',
        fonts: TemplateAppPath + '/fonts/**/*.*',
        jsDependencies: [
            TemplateAppPath + '/js/*.js',
        ],
        cssDependencies: [
            '/node-modules/normalize.css/normalize.css',
            '/node-modules/slick-carousel/slick/slick.less',
            '/node-modules/slick-carousel/slick/slick-theme.less',
            TemplateAppPath + '/less/*.less',
        ]
    },
    watch: { //watch folder _ files
        html: TemplateAppPath + '/**/*.*',
...
gulp.task('less:build', function () {
    return gulp.src(path.src.cssDependencies)
...
gulp.task('js:build', function () {
    return gulp.src(path.src.jsDependencies)
